...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    public sealed class ViewsForBaseEntitySets4BD909B27BDEDD36FAE4C72784314C86 : System.Data.Mapping.EntityViewContainer
    {
        ...
        public ViewsForBaseEntitySets4BD909B27BDEDD36FAE4C72784314C86()
        {
            ...
            this.HashOverAllExtentViews = "7e1748a6b5ef3fd844d475a2e25b3c8e";
            this.ViewCount = 36;
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView1()
        {
            ...
            viewString.Append("tory](T4.Story_Id, T4.Story_UniqueName, T4.Story_Title, T4.Story_HtmlDescription");
            viewString.Append(", T4.Story_TextDescription, T4.Story_Url, T4.Story_UrlHash, T4.Story_CategoryId,");
            viewString.Append(" T4.Story_UserId, T4.Story_IPAddress, T4.Story_CreatedAt, T4.Story_LastActivityA");
            viewString.Append("t, T4.Story_ApprovedAt, T4.Story_PublishedAt, T4.Story_Rank, T4.Story_LastProces");
            viewString.Append("sedAt)\r\n    FROM (\r\n        SELECT T1.Story_Id, T3.Story_UniqueName, T3.Story_Ti");
            viewString.Append("tle, T3.Story_HtmlDescription, T3.Story_TextDescription, T3.Story_Url, T3.Story_");
            viewString.Append("UrlHash, T2.Story_CategoryId, T1.Story_UserId, T3.Story_IPAddress, T3.Story_Crea");
            viewString.Append("tedAt, T3.Story_LastActivityAt, T3.Story_ApprovedAt, T3.Story_PublishedAt, T3.St");
            viewString.Append("ory_Rank, T3.Story_LastProcessedAt, T3._from0, T2._from1, T1._from2\r\n        FRO");
            viewString.Append("M  (\r\n            SELECT \r\n                Key(T.Story).Id AS Story_Id, \r\n      ");
            viewString.Append("          Key(T.User).Id AS Story_UserId, \r\n                True AS _from2\r\n    ");
            viewString.Append("        FROM KiggEntityContainer.FK_Story_User AS T) AS T1\r\n            INNER JO");
            viewString.Append("IN (\r\n            SELECT \r\n                Key(T.Story).Id AS Story_Id, \r\n      ");
            viewString.Append("          Key(T.Category).Id AS Story_CategoryId, \r\n                True AS _fro");
            viewString.Append("m1\r\n            FROM KiggEntityContainer.FK_Story_Category AS T) AS T2\r\n        ");
            viewString.Append("    ON T1.Story_Id = T2.Story_Id\r\n            INNER JOIN (\r\n            SELECT \r");
            viewString.Append("\n                T.Id AS Story_Id, \r\n                T.UniqueName AS Story_Uniqu");
            viewString.Append("eName, \r\n                T.Title AS Story_Title, \r\n                T.HtmlDescrip");
            viewString.Append("tion AS Story_HtmlDescription, \r\n                T.TextDescription AS Story_Text");
            viewString.Append("Description, \r\n                T.Url AS Story_Url, \r\n                T.UrlHash A");
            viewString.Append("S Story_UrlHash, \r\n                T.IpAddress AS Story_IPAddress, \r\n           ");
            viewString.Append("     T.CreatedAt AS Story_CreatedAt, \r\n                T.LastActivityAt AS Story");
            viewString.Append("_LastActivityAt, \r\n                T.ApprovedAt AS Story_ApprovedAt, \r\n         ");
            viewString.Append("       T.PublishedAt AS Story_PublishedAt, \r\n                T.Rank AS Story_Ran");
            viewString.Append("k, \r\n                T.LastProcessedAt AS Story_LastProcessedAt, \r\n             ");
            viewString.Append("   True AS _from0\r\n            FROM KiggEntityContainer.Story AS T) AS T3\r\n     ");
            viewString.Append("       ON T1.Story_Id = T3.Story_Id\r\n    ) AS T4");
            return new System.Collections.Generic.KeyValuePair<string, string>("KiggStorageEntityContainer.Story", viewString.ToString());
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView13()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("KiggEntityContainer.Story", "\r\n    SELECT VALUE -- Constructing Story\r\n        [Kigg.EF.DomainObjects.Story](T" +
                    ...
                    "K_Story_User.User.Id]),[Kigg.EF.DomainObjects.User]),[Kigg.EF.DomainObjects.FK_S" +
                    "tory_User],Story,User) \r\n    FROM (\r\n        SELECT \r\n            T.Id AS Story_" +
